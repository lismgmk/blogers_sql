...
export class temprorFix31672091565771 implements MigrationInterface {
    name = 'temprorFix31672091565771'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_devices_device" ADD "userId" uuid NOT NULL`);
